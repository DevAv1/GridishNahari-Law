            ...
            <div className="about-content">
                ...
                >
                    <p>
                        ...
                        דוברי אנגלית שאחד מהם לעיתים שוהה מחוץ לארץ. לעו"ד נהרי נסיון רב בניהול תיקים מגוונים ומורכבים
                        בתחום דיני המשפחה ובהופעות בערכאות השיפוט השונות. צוות המשרד מלווה את לקוחותיו החל משלב ההחלטה
                        הראשונית, בונה אסרטגיה מנצחת מדריך הלקוח על בסיס יום יומי ,ומלווה אותו עד לסיום הטיפול בתיק,
                        במקצועיות ובנחישות ועובד עם מיטב המומחים בתחום.
                        <br/>
                        <br/>
